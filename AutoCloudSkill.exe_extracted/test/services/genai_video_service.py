...
# Internal filename: services\genai_video_service.py
...
class GenAIVideoService:
    ...
    def generate_video(self, *, prompt: str, model: str='veo-3.0-generate-001', aspect_ratio: Optional[str]=None, negative_prompt: Optional[str]=None, image: Optional[Any]=None, resolution: Optional[str]=None, poll_interval: int=10) -> Dict[str, Any]:
        ...
        return {'operation': operation, 'generated_video': operation.response.generated_videos[0], 'generated_videos': operation.response.generated_videos}
