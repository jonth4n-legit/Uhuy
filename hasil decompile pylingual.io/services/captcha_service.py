"""
Service untuk menyelesaikan captcha menggunakan speech recognition (audio-only).
"""
...
class CaptchaSolverService:
    ...
    def solve_audio_captcha(self, audio_url: str) -> Optional[str]:
        ...
        try:
            ...
            try:
                return self._process_audio_file(temp_file_path)
            finally:
                try:
    ...
    def _process_audio_file(self, file_path: str) -> Optional[str]:
        try:
            ...
            logger.debug('SpeechRecognition unknown value error')
    ...
    def _convert_to_wav_16k_mono(self, file_path: str) -> str:
        """Konversi ke WAV 16k mono dengan ffmpeg; fallback moviepy jika gagal."""
