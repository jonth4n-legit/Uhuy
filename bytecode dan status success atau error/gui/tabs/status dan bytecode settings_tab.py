...
<module>.SettingsTab: Success: Equal

<module>.SettingsTab.__init__: Success: Equal

***<module>.SettingsTab._build: Failure: Different bytecode

<module>.SettingsTab._build._on_frame_configure: Success: Equal

***<module>.SettingsTab._build._on_mousewheel: Failure detected at line number 43 and instruction offset 56: Different bytecode

<module>.SettingsTab._build._bind_wheel: Success: Equal

<module>.SettingsTab._build._unbind_wheel: Success: Equal

***<module>.SettingsTab._build._update_scrollregion: Failure: Different bytecode

<module>.SettingsTab._build.<lambda>: Success: Equal

<module>.SettingsTab._build.<lambda>: Success: Equal

***<module>.SettingsTab._build._on_tab_changed: Failure: Different bytecode
